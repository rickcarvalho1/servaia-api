      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-2">
          <Link href="/dashboard/jobs/schedule"
            className="flex items-center gap-2 px-4 py-2.5 text-[#0E1117] text-sm font-semibold rounded-lg border border-[#DDE1EC] bg-white hover:bg-gray-50 transition-colors">
